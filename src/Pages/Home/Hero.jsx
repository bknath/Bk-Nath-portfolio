    ...
    return (
        <div className="wrapper-home-section">
            <div className="content flex flex-col items-center justify-center text-center mt-20">
                ...
                <p className='intropara font-medium mt-2 w-1/2 animation-fadeinup'>As a passionate full stack web developer, with expertise in frontend and backend technologies, I thrive on building dynamic, scalable applications and creating seamless user experiences that drive real-world impact.</p>
